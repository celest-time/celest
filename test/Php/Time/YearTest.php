...
//-----------------------------------------------------------------------
     ...
     * @expectedException \Php\Time\Temporal\UnsupportedTemporalTypeException
     */
    ...
    function data_minus_long_TemporalUnit()
    {
        return [
            ...
            [
                Year::of(-999999999), 1, ChronoUnit::YEARS(), null, 'Php\Time\DateTimeException'],
            [
                Year::of(1), -999999999, ChronoUnit::YEARS(), null, 'Php\Time\DateTimeException'],
