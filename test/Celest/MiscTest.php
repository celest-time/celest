...
class MiscTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testIntlDate() {
        ...
        //$this->assertEquals('AH 1420 Shawwal 27, Thu 05:05:00 GMT+01:00', $formatter1->format($date), 'islamic-umalqura');
        $this->assertEquals('AH 1420 Shawwal 27, Thu 05:05:00 GMT+01:00', $formatter2->format($date), 'islamic-civil');
